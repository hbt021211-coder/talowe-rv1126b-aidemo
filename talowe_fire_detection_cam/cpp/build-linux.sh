...
TARGET_SOC=rv1126b
TARGET_ARCH=aarch64
BUILD_DEMO_NAME=fire
export GCC_COMPILER=/home/talowe/talowe_rv1126b_linux6.1_sdk_v1.0/buildroot/output/rockchip_rv1126b/host/bin/aarch64-buildroot-linux-gnu
echo "$GCC_COMPILER"
...
TARGET_SDK="rknn_${BUILD_DEMO_NAME}_detection_cam"
